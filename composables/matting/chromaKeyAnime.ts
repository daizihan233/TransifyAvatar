...
export async function removeBackgroundChromaAnime(
    ...
    if (erosionTolerance > 0) {
        preciseEdgeErosion(bgMask, data, w, h, n, { r: tr, g: tg, b: tb, h: th, s: ts, v: tv }, useHsv, tol, erosionTolerance, edgePrecision, aggressiveEdgeRemoval)
    ...
    if (edgeFeather > 0 || antiAlias) {
        applyEdgeFeatheringAndAntiAlias(bgMask, alphaMap, data, distArr, w, h, n, { r: tr, g: tg, b: tb, h: th, s: ts, v: tv }, useHsv, tol, edgeFeather, antiAlias)
